...
| 2 | 閲覧側ページ移植 (トップ/メンバー/ブログ/イベント/掲示板/RSS) | ✅ 完了 |
| 3 | 管理画面移植 (イベント/ブログ/メンバー/掲示板/お問い合わせ/ヒーロー) | ✅ 完了 |
| 4 | 認証 + マイページ (登録/ログイン/パスワードリセット/プロフィール編集) | ✅ 完了 |
| 5 | Render 切替 (`render.yaml` + CI 済) — Supabase セットアップ後にデプロイ可 | ✅ 準備完了 |
